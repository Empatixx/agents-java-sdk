...
public sealed interface RunItem permits RunItem.UserInput, RunItem.MessageOutput, RunItem.ToolCallItem, RunItem.ToolOutputItem, RunItem.HandoffItem {
    record UserInput(String content) implements RunItem {}
